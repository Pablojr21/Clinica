...
public class detalleCita extends AppCompatActivity {
    ...
    private void cargarDetalleCita(String codigoCita) {
        ...
        String url = "http://192.168.0.7:80/cita/mostrar_citaxcodigo.php?codigo_cita=" + codigoCita;
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (citasArray.length() > 0) {
                                ...
                                txvpaciente.setText("Pacinete: "+cita.getString("nombre_paciente")+ " "+ cita.getString("apellido_paciente"));
